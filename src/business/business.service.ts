...
export class BusinessService {
  ...
  //   console.log("Salom mostBrend servicedan");
  //   const result = await this.businessRepo.findAll({
  ...
  //       include: [
  //         [
  //           this.sequelize.fn('AVG', this.sequelize.col('stars.star')),
  //           'average_star',
  //         ],
  //         [
  //           this.sequelize.fn(
  //             'SUM',
  //             this.sequelize.col('products.quantity_of_selling'),
  //           ),
  //           'totalQuantityOfSelling',
  //         ],
  //       ],
  //     },
  //     group: ['Business.id'],
  //     order: [
  //       [this.sequelize.literal('average_star'), 'DESC'],
  //       ['likes', 'DESC'],
  //       [this.sequelize.literal('totalQuantityOfSelling'), 'DESC'],
  //     ],
  //     limit: 10, // For example, limit to top 10
  //   });
  //   console.log('Xayr servicedan');
